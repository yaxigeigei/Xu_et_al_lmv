%% Determine unit responsiveness using Wilcoxon signed rank test

anaDir = LMV.Data.GetAnalysisDir('phase_resp', 'signrank');
...
for i = 1 : height(srcTb)
    ...
    pTb = NP.Resp.PhaseSignrank(respTb, phaseTb(:, ["baseline" phaseNames]), stimIdTb, LMV.Param.stimIdList4);
