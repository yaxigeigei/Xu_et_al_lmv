...
for i = 1 : height(srcTb)
    ...
    % Load se
    % sePath = fullfile(LMV.Data.GetAnalysisDir, "data", "se_m1", strrep(srcTb.name{i}, "_se.mat", "_se_m1.mat"));
    sePath = srcTb.path{i};
    ...
    % Exclude non-selective units
    sTest = LMV.Resp.LoadSentenceSelectTest(recId);
